...
| [0030](0030-unified-hydration.md) | Unified hydration via effect-typed classification (`view()`) | classifier shipped report-only; `view()` factory deferred | 2026-05-15 |
...
| [0055](0055-critical-action-high-assurance-server-actions.md) | `criticalAction()` — high-assurance server actions (Phases 1–4 shipped; 5 `shape()` codegen shipped, `fromStandard()` plugin deferred) | accepted | 2026-05-20 |
