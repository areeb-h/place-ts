...
| [0055](0055-critical-action-high-assurance-server-actions.md) | `criticalAction()` — high-assurance server actions (Phases 1–4 shipped; 5 specified) | accepted | 2026-05-20 |
