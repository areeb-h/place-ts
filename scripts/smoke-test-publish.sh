...
const local = {
  ...
  '@place-ts/component':  'file:$REPO/systems/component/place-ts-component-0.10.1.tgz',
  '@place-ts/data':       'file:$REPO/systems/data/place-ts-data-0.2.0.tgz',
  '@place-ts/design':     'file:$REPO/systems/design/place-ts-design-0.3.0.tgz',
